...
export function PortfolioSection() {
  const project = {
    title: "CRUD Todo App",
    description:
      "A responsive todo application showcasing CRUD operations with an emphasis on clean UI and UX.",
    technologies: ["React JS", "Next Js", "Tailwind CSS"],
    image: "/images/todo-app-result.png",
  };

  return (
    <section id="portfolio" className="py-12 md:py-20 bg-orange-100">
      <Container>
